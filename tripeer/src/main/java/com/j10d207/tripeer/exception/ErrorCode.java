...
public enum ErrorCode {
    ...
    NOT_TRIPPER_USER(HttpStatus.BAD_REQUEST, "ACCOUNT-011", "트리피어 계정 유저가 아닙니다. 다른 로그인 방법을 시도하세요."),
    ...
    TOO_MANY_PLAN(HttpStatus.FORBIDDEN, "PLAN-004", "사용자가 너무 많은 플랜을 가지고 있습니다."),
