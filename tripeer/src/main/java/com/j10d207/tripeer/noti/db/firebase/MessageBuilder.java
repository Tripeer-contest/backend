...
public class MessageBuilder {
	...
	private static final String TRIPEER_START_CONTENT_TEMPLATE = "계획하신 %s여행 시작날입니다. %s님, 즐겁고 안전한 여행 되세요~!";
	...
	private static final String INVITE_CONTENT_TEMPLATE = "%s여행에 초대되셨습니다. 수락하시겠습니까?";
